                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Create Restaurant Table</h6>
                        </div>
                        <div class="card-body">
                            <form class="row g-3 maskking-form" id="table_form">
                                @csrf
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="table_name"
                                            placeholder="Table Name" name="restaurant_table_name">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="table_entry_id"
                                            placeholder="Table Entry ID" name="restaurant_table_entry_id" readonly>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <textarea cols="10" rows="5" class="form-control form-control-lg" id="table_description"
                                            placeholder="Table Description" name="restaurant_table_description"></textarea>
