...
<!-- Form section -->
        ...
        <div class="container-fluid">
            <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="col text-md-end">
                    <a class="btn btn-primary" href="{{ url('product-category') }}"><i class="fa fa-list me-2"></i>List of Menu</a>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Edit Menu</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="product_category_name"
                                            placeholder="product_category Name" name="product_category_name" value="{{$data->product_category_name}}">
                                        <label class="form-label" for="TextInput">Menu Name</label>
                                    </span>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        <input type="text" class="form-control form-control-lg" id="product_category_entry_id"
                                            placeholder="product_category Entry ID" name="product_category_entry_id" value="{{$data->product_category_entry_id}}" readonly>
                                        <label class="form-label" for="TextInput">Menu Entry ID</label>
                                    </span>
                                </div>
    ...
    <script type="text/javascript">
        $("#product_category_form").submit(function(e) {
            ...
            let getpassport_id = $("[name=product_category_id]").val();
            $('#loader').show();
            $.ajax({
                headers: {
                ...
                method: "POST",
                url: "{{ url('product-category') }}/" + $("[name=product_category_id]").val(),
                data: data,
                cache: false,
                contentType: false,
                processData: false,
