                ...
                <div class="col-lg-12 mb-lg-3">
                    ...
                    <div class="row g-4 img-style">
                        <div class="col-lg-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        <label class="labl">
                                            ...
                                            <div class="kkk">
                                                <div class="card bg-info" id="dine_in_bg">
                                                    <div class="card-body">
                                                        <div class="avatar lg">
                                                            <img class="img-fluid"
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <label class="labl">
                                            ...
                                            <div class="lll">
                                                <div class="card bg-info" id="take_out_bg">
                                                    <div class="card-body text-white">
                                                        <div class="avatar lg">
                                                            <img class="img-fluid"
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <label class="labl">
                                            <input type="radio" name="customer_type" class="promil"
                                                value="food_delivery" />
                                            <div class="lll">
                                                <div class="card bg-info" id="food_delivery_bg">
                                                    <div class="card-body text-white">
                                                        <div class="avatar lg">
                                                            <img class="img-fluid"
                                            ...
                                            <div class="card-body">
                                                <div class="row g-3 row-deck">
                                                    ...
                                                    <input type="hidden" id="hidden_client_number"
                                                        name="hidden_client_number" value="123456789">
                            ...
                            {{-- 4px dashed #6a4949 --}}
                            <div class="section text-black card mt-3" id="table_div"
                                style="background: #4169e1;display:none">
                                <div class="container-fluid">
                                                ...
                                                <label class="labl">`
                                                    ...
                                                    <div class="">
                                                        <div class="bg-card p-3 rounded-3 text-center m-3 m-md-0"
                                                            id="table_id_{{ $table->restaurant_table_id }}"
                                                            rest-row="{{ $table->restaurant_table_id }}"
                                                            class="table_id_{{ $table->restaurant_table_id }}"">
                            ...
                            <div class="card fieldset border border-primary">
                                ...
                                <div class="owl-carousel owl-theme" id="recent_invoices">
                                    ...
                                    <div class="item card">
                                        <a href="#" branch_id="{{ Auth::user()->branch_id }}" product_cat="0"
                                ...
                                <div class="py-lg-2 py-1 mt-0 mt-lg-3">
                                    <div class="card text-center bg-info text-white">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="d-flex flex-wrap justify-content-between">OverAll Discount:
                                                <strong id="overAllDiscount"></strong>
                                            </h6>
                                            ...
                                            <button type="submit" class="btn w-100"
                                                style="background:#ed0016;font-size:24px">Confirm Bill</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#myInput").on("keyup", function() {
                ...
                $(".dynamic_product *").filter(function() {
                ...
                success: function(data) {
                    ...
                    $('.meow').on('click', function(e) {
                        ...
                        var billing_content =
                            ...
                            '</span>' +
                            '</strong>' +
                            '<button type="button" id="del_button">x</button>' +
                            '</div>' +
                        ...
                        $('#del_button').on('click', function() {
                            ...
                            $('.billing-details-row:last').remove();
                            //alert();
                        });
        ...
        $(document).ready(function() {
            ...
            $(document).on('blur', '#overall_discount', function() {
                ...
                $('#overAllDiscount').text(overall_discount);
