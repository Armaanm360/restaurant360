        ...
        <div class="section pt-0">
            <div class="container-fluid">
                ...
                <form class="row maskking-form" id="add_form">
                    ...
                    <input type="hidden" value="{{ $invoice_edit[0]->sale_id }}" name="sale_id" id="sale_id">
                    {{-- <div class="row">
                <div class="col-lg-12 mb-lg-3">
                    ...
                    <input type="hidden" name="customer_type_hidden" value="{{ $invoice_edit[0]->customer_type }}">
                                            ...
                                            <div class="card-body">
                                                <div class="row g-3 row-deck">
                                                    <input type="text" class="form-control form-control-lg"
                                                        id="clientName" placeholder="Client Name" readonly
                                                        name="client_name"
                                                    ...
                                                    <input type="text" class="form-control form-control-lg"
                                                        id="clientNumber" placeholder="Customer Number" readonly
                                                        name="client_number"
                            ...
                            <div class="py-lg-2 py-1 mt-0 mt-lg-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 row-deck">
                                            <h4>Order No : #<span
                                                    id="invoice_unique_id">{{ $invoice_edit[0]->invoice_no }}</span></h4>
                                            <h4>Order Type : <span id="order_type"></span></h4>
                                            <h4 id="rest_table">Table No : <span
                                                    id="table_get_id">{{ $invoice_edit[0]->restaurant_table_id }}</span>
                                            </h4>
                                            <input type="hidden" id="invoice_unique_inp" name="invoice_no">
                                            <input type="hidden" name="rest_table_get" id="rest_table_get"
                                                value="{{ $invoice_edit[0]->restaurant_table_id }}">
                                                                ...
                                                                <tr class="item-row billing-details-row">
                                                                    <div class="col-sm-12 item-row billing-details-row">
                                                                        <div class="d-flex align-items-center fs-5 mb-3">
                                                                            <div class="rounded no-thumbnail"> <input
                                                                                    type="hidden"
                                                                                    name="product_{{ $sl }}"
                                                                                    value="{{ $invoice_edit->product_id }}"><img
                                                                                    class="img-fluid"
                                                                                    src="{{ url('/') }}/public/uploads/products/{{ $invoice_edit->product_image }}"
                                                                                    width="60">
                                                                            </div>
                                                                            <div class="ms-2">
                                                                                <div class="row"
                                                                                    ...
                                                                                    <div class="col-3">
                                                                                        <span><strong>{{ $invoice_edit->product_name }}
                                                                                            </strong></span>
                                                                                    </div>
                                                                                    <div class="col-3"><span
                                                                                            class="text-danger text-right">{{ $invoice_edit->product_retail_price }}</span>
                                                                                        X <span
                                                                                            class="total_quan_price_{{ $sl }}"
                                                                                            data-row="{{ $sl }}"></span>
                                                                                    </div>
                                                                                    <div class="col-3">
                                                                                        <input type="number"
                                                                                    ...
                                                                                    <div class="col-3"><strong>
                                                                                            ...
                                                                                            <input type="hidden"
                                                                                                class="qty billing-quantity total_unit_price total_price_quantity_{{ $sl }}"
                                                                                                data-row="{{ $sl }}"
                                                                                                name="total_price_quantity_{{ $sl }}">

                                                                                            <input readonly type="hidden"
                                                                                                name="with_discount_{{ $sl }}"
                                                                                                class="with_discount_{{ $sl }} with_discount"
                                                                                                data-row="{{ $sl }}">

                                                                                            <input type="hidden"
                                                                                                name="item_discount_{{ $sl }}"
                                                                                                class="item_discount_{{ $sl }} discount_get"
                                                                                                data-row="{{ $sl }}">
                                                                                            <span
                                                                                                class="sub_total_price_{{ $sl }}
                                                                                                data-row="{{ $sl }}>
                                                                                                {{ $invoice_edit->quantity * $invoice_edit->product_retail_price }}</span></strong>
                                                                                    </div>
                                                                                    <div
                                                                                        class="h6
                                                                                                mb-0 text-success">
                                                                                        ...
                                                                                        <input type="hidden"
                                                                                            name="item_price_{{ $sl }}"
                                                                                            class="cost billing-unit-price item_price item_price_{{ $sl }}"
                                                                                            step="1"
                                                                                            placeholder="pcs"
                                                                                            data-row="{{ $sl }}
                                                                                            style="width:-webkit-fill-available"
                                                                                            value="{{ $invoice_edit->product_retail_price }}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="card text-center bg-danger text-white">
                                        <div class="card-body">
                                            <h6 class="d-flex flex-wrap justify-content-between">Sub Total :
                                                <strong id="invoiceSubTotal">{{ $invoice_edit->subTotal }}</strong>
                                            ...
                                            <h6 class="d-flex flex-wrap justify-content-between">Tax 5% :
                                                <strong id="vat_amount_text">{{ $invoice_edit->vat_amount }}</strong>
                                            ...
                                            <h5 class="d-flex flex-wrap justify-content-between mt-1">Total :
                                                <strong id="grand_total_text">{{ $invoice_edit->grand_total }}</strong>

                                                <input type="hidden" name="grand_total" id="grand_total"
                                                    value="{{ $invoice_edit->grand_total }}" readonly>
                                            </h5>
                    ...
                    {{-- <input id="hidden_sub" value=" {{ $invoice_edit->grand_total - $invoice_edit->vat_amount }}"> --}}
    ...
    <div class="modal fade" id="ConnectionRequest" tabindex="-1" aria-hidden="true">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                // var billing_row = $('qty_get').attr('data-row');
                ...
                let cust_type = $("input:hidden[name=customer_type_hidden]").val();
                if (cust_type == 'dine_in') {

                    $('div#table_div').show();
                    $('#customer_type_hidden').val('dine_in');
                ...
                if (cust_type == 'take_out') {
                    $('#customer_type_hidden').val('take_out');
                    $('div#table_div').hide();
                ...
                if (cust_type == 'food_delivery') {
                    $('#customer_type_hidden').val('food_delivery');
                    $('div#table_div').hide();
            ...
            $(document).ready(function() {
                ...
                $(document).on('blur', '#overall_discount', function() {
                    ...
                    $('#grand_total').val(Math.round(grand_total -
                        overall_discount));
                    $('#grand_total_text').text(Math.round(grand_total -
                        overall_discount));
                    $('#grand_total').val(Math.round(((get_sub_total() * (vat_rate / 100)) +
                            get_sub_total()) -
                        overall_discount));
