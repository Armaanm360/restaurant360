                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg"
                                            value="{{ getBranchName(Auth::user()->id) }}" id=""
                                            name="branch_id_get" readonly>
                                        <input type="hidden" class="form-control form-control-lg"
                                            value="{{ Auth::user()->id }}" id="branch_id_get" name="hidden_branch_id">
                                    ...
                                    <div class="col-lg-3 col-sm-12">
                                        <span class="float-label">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="invoice_no"
                                                placeholder="Invoice No" name="invoice_no" readonly>
                                        </span>
                                    </div>
                                    {{-- </div> --}}
                                    <br>
                                ...
                                <div class="row">
                                    @foreach ($product_cat as $product_cat)
                                        <div class="col-3">
                                            <button type="button" class="get_product_cat btn btn-sm btn-success m-3"
                                                product_cat="{{ $product_cat->product_category }}"
                                                branch_id="{{ Auth::user()->branch_id }}">{{ getProductCategory($product_cat->product_category) }}</button>
                                        </div>
                                    @endforeach
                                    <div class="col-3" id="productsGet">
                                        <h2 class="mwws"></h2>
                                    </div>
                                </div>
