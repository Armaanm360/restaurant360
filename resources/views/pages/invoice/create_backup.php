    ...
    <div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-0 mt-lg-3">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Add Bill</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <select class="form-control form-control-lg" id="customer_type" name="customer_type">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    ...
                                    {{-- <select class="select2 form-control" style="width:500px;" name="branch_id_get"
                                            id="branch_id_get">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="{{ getBranchName(Auth::user()->id) }}" id="" name="branch_id_get" readonly>
                                    <input type="hidden" class="form-control form-control-lg" value="{{ Auth::user()->id }}" id="branch_id_get" name="hidden_branch_id">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    ...
                                    <select class="select2 form-control" style="width:500px;" name="restaurant_table_id" id="restaurant_table_id">
                                        <option class="selected" disabled>Select</option>

                                        @foreach ($table as $row)
                                        <option value="{{ $row->restaurant_table_id }}">
                                            {{ $row->restaurant_table_name }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    ...
                                    <select class="select2 form-control" style="width:500px;" name="hidden_staff_id" id="staff_id">
                                        <option class="selected" disabled>Select</option>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    ...
                                    <span class="float-label">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="clientName" placeholder="Client Name" name="client_name">
                                    </span>
                                    ...
                                    <!-- Modal -->
                                    <button class="btn btn-primary px-4 text-uppercase" data-bs-toggle="modal" data-bs-target="#ConnectionRequest" type="button">Add Customer</button>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="clientNumber" placeholder="Customer Number" name="client_number" value="">
                                    </span>
                                    <input type="hidden" id="hidden_client_number" name="hidden_client_number" value="">
                                </div>

                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        <label for="warehouse">Invoice No</label>
                                        <input type="text" class="form-control form-control-lg" id="invoice_no" placeholder="Invoice No" name="invoice_no" readonly>
                                    </span>
                                </div>
                                {{-- </div> --}}
                                <br>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="product_get" placeholder="Scan/Search Product by Name/Code" name="account">
                                    </span>
                                    <input type="hidden" id="hiddenAccId" name="expense_account">
                                </div>
                            </div>
                            <div class="row delivery">
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <select class="form-control form-control-lg" id="delivery_man" name="delivery_man">
                                            <option disabled selected>Select</option>
                                            @foreach ($delivery as $delivery)
                                            <option value="{{ $delivery->delivery_men_id }}">
                                                {{ $delivery->delivery_men_name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </span>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <span class="float-label">
                                        ...
                                        <input type="text" readonly class="form-control form-control-lg" id="vehicle" value="">
                                    </span>
                                </div>
                            </div>
                            <br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="total-value">
                                            ...
                                            <input type="number" name="invoice_subtotal" id="invoiceSubTotal" value="" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="10" class="total-line" style="text-align: right;border:0">
                                            Product Discount</td>
                                        <td class="total-value">
                                            <input type="number" name="product_discount" id="productDiscount" value="" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="10" class="total-line" style="text-align: right;border:0">
                                            Vat Rate(%)</td>
                                        <td class="total-value">
                                            <input type="number" name="vat_rate" id="vat_rate" value="7.50" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="10" class="total-line" style="text-align: right;border:0">
                                            Vat Amount(%)</td>
                                        <td class="total-value">
                                            <input type="number" name="vat_amount" id="vat_amount" value="" readonly>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="10" class="total-line" style="text-align: right;border:0">
                                            Overall Discount</td>
                                        <td class="total-value">
                                            <input type="number" name="overall_discount" id="overall_discount" value="">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="10" class="total-line" style="text-align: right;border:0">
                                            Grand Total</td>
                                        <td class="total-value">
                                            <input type="number" name="grand_total" id="grand_total" value="" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="total-value">
                                            <span class="float-label">
                                                <select class="form-control form-control-lg" id="payment_type" name="payment_type">
                                    ...
                                    <tr>
                                        ...
                                        <td class="total-value">
                                            <span class="float-label">
                                                <select class="form-control form-control-lg" id="getAccount" name="account">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="10" class="total-line" style="text-align: right;border:0">
                                            Total Paying</td>
                                        <td class="total-value">
                                            <input type="number" name="paid_amount" id="paid_amount" value="">
                                        </td>
                                    </tr>
                                    <tr>

                                        <td colspan="10" class="total-line balance" style="text-align: right;border:0" id="changed_text_due">Change</td>
                                        <td class="total-value balance">
                                            <div class="due">
                                                <input class="invoice-due" type="number" name="changed_amount" id="changed_amount" value="" readonly>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <div class="col-12 text-center text-md-end" id="InvoiceButtonArea">
                <button type="submit" class="btn btn-lg btn-primary"><i class="fa fa-print me-2"></i>Save
                    Bill</button>
                        ...
                        <form id="addClientForm" style="width: 100%">
                            <div class="flex-fill ms-3">
                                ...
                                <span class="float-label">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="addClientName" placeholder="Customer Number" name="client_name" value="">
                                </span>
                                <br>
                                <span class="float-label">
                                    <label for="clientNumber">Customer Number</label>
                                    <input type="text" class="form-control form-control-lg" id="addClientPhone" placeholder="Customer Number" name="client_phone_number" value="">
                                </span>
                            ...
                            <div class="d-flex align-items-center" style="margin-top: 5%;float: right;">
                                <button class="btn mx-1 btn-light-primary"><i class="fa fa-check"></i><span class="d-none d-lg-inline-block ms-2">Save Customer</span></button>
