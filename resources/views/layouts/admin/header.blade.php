                        ...
                        <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                            <div class="card">
                                <div class="row g-1 text-center p-3" style="width: 302px;">
                                    <div class="col-6">
                                        <a class="card p-3 color-600 lift align-items-center" href="{{ 'invoice' }}"
                                            title="">
                                    ...
                                    <div class="col-6">
                                        <a class="card p-3 color-600 lift align-items-center" href="{{ 'accounts' }}"
                                            title="">
                                            <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                        <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#"
                            ...
                            <img class="avatar img-thumbnail rounded-circle shadow"
                                src="{{ url('public/assets') }}/img/profile_av.png" alt="">
                        </a>
