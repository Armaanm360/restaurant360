      ...
      <div class="container-fluid">
          ...
          <div class="title-text d-flex align-items-center mb-4 mt-1">
              <h4 class="sidebar-title mb-0 flex-grow-1">
                  ...
                  <!--<span class="sm-txt">Restaurant</span><span> 360</span></h4>-->
              ...
              <ul class="menu-list">
                  ...
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Applications" href="#">
                          ...
                          <span class="ms-2">POS Sale</span>
                          <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                      </a>
                      <!-- Menu: Sub menu ul -->
                      <ul class="sub-menu collapse" id="menu-Applications">
                          <li><a class="ms-link" href="{{ url('invoice/create') }}">Create Pos Sale</a></li>
                          <li><a class="ms-link" href="{{ url('today-invoices') }}"> Today POS Sales</a></li>
                          <li><a class="ms-link" href="{{ url('invoice') }}">List of POS Sales</a></li>
                      </ul>
                  </li>
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Account">
                          <li><a class="ms-link" href="{{ url('money-receipt/create') }}">Receive Client Payment</a>
                          </li>
                  ...
                  <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Menu" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M2 1C1.46957 1 0.960859 1.21071 0.585786 1.58579C0.210714 1.96086 0 2.46957 0 3L0 13C0 13.5304 0.210714 14.0391 0.585786 14.4142C0.960859 14.7893 1.46957 15 2 15H14C14.5304 15 15.0391 14.7893 15.4142 14.4142C15.7893 14.0391 16 13.5304 16 13V3C16 2.46957 15.7893 1.96086 15.4142 1.58579C15.0391 1.21071 14.5304 1 14 1H2ZM1 3C1 2.73478 1.10536 2.48043 1.29289 2.29289C1.48043 2.10536 1.73478 2 2 2H14C14.2652 2 14.5196 2.10536 14.7071 2.29289C14.8946 2.48043 15 2.73478 15 3V13C15 13.2652 14.8946 13.5196 14.7071 13.7071C14.5196 13.8946 14.2652 14 14 14H2C1.73478 14 1.48043 13.8946 1.29289 13.7071C1.10536 13.5196 1 13.2652 1 13V3ZM2 5.5C2 5.36739 2.05268 5.24021 2.14645 5.14645C2.24021 5.05268 2.36739 5 2.5 5H6C6.13261 5 6.25979 5.05268 6.35355 5.14645C6.44732 5.24021 6.5 5.36739 6.5 5.5C6.5 5.63261 6.44732 5.75979 6.35355 5.85355C6.25979 5.94732 6.13261 6 6 6H2.5C2.36739 6 2.24021 5.94732 2.14645 5.85355C2.05268 5.75979 2 5.63261 2 5.5ZM2 8.5C2 8.36739 2.05268 8.24021 2.14645 8.14645C2.24021 8.05268 2.36739 8 2.5 8H6C6.13261 8 6.25979 8.05268 6.35355 8.14645C6.44732 8.24021 6.5 8.36739 6.5 8.5C6.5 8.63261 6.44732 8.75979 6.35355 8.85355C6.25979 8.94732 6.13261 9 6 9H2.5C2.36739 9 2.24021 8.94732 2.14645 8.85355C2.05268 8.75979 2 8.63261 2 8.5ZM2 10.5C2 10.3674 2.05268 10.2402 2.14645 10.1464C2.24021 10.0527 2.36739 10 2.5 10H6C6.13261 10 6.25979 10.0527 6.35355 10.1464C6.44732 10.2402 6.5 10.3674 6.5 10.5C6.5 10.6326 6.44732 10.7598 6.35355 10.8536C6.25979 10.9473 6.13261 11 6 11H2.5C2.36739 11 2.24021 10.9473 2.14645 10.8536C2.05268 10.7598 2 10.6326 2 10.5Z" />
                    ...
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="menu-Menu">
                        <li><a class="ms-link" href="{{ url('product-category/create') }}">Add New Menu</a></li>
                        <li><a class="ms-link" href="{{ url('product-category') }}">List of Menu</a></li>
                    </ul>
                </li>
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Products">
                          <li><a class="ms-link" href="{{ url('products/create') }}">Add New Menu Item</a></li>
                          <li><a class="ms-link" href="{{ url('products') }}">List of Menu Item</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Inventory">
                          <li><a class="ms-link" href="{{ url('inventory') }}">Inventory</a></li>
                          {{-- <li><a class="ms-link" href="">Adjustment</a></li>
                          <li><a class="ms-link" href="">Adjustment List</a></li> --}}
                      </ul>
                  </li>
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Transfer" href="#">
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor"
                              viewBox="0 0 16 16">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M2 1C1.46957 1 0.960859 1.21071 0.585786 1.58579C0.210714 1.96086 0 2.46957 0 3L0 13C0 13.5304 0.210714 14.0391 0.585786 14.4142C0.960859 14.7893 1.46957 15 2 15H14C14.5304 15 15.0391 14.7893 15.4142 14.4142C15.7893 14.0391 16 13.5304 16 13V3C16 2.46957 15.7893 1.96086 15.4142 1.58579C15.0391 1.21071 14.5304 1 14 1H2ZM1 3C1 2.73478 1.10536 2.48043 1.29289 2.29289C1.48043 2.10536 1.73478 2 2 2H14C14.2652 2 14.5196 2.10536 14.7071 2.29289C14.8946 2.48043 15 2.73478 15 3V13C15 13.2652 14.8946 13.5196 14.7071 13.7071C14.5196 13.8946 14.2652 14 14 14H2C1.73478 14 1.48043 13.8946 1.29289 13.7071C1.10536 13.5196 1 13.2652 1 13V3ZM2 5.5C2 5.36739 2.05268 5.24021 2.14645 5.14645C2.24021 5.05268 2.36739 5 2.5 5H6C6.13261 5 6.25979 5.05268 6.35355 5.14645C6.44732 5.24021 6.5 5.36739 6.5 5.5C6.5 5.63261 6.44732 5.75979 6.35355 5.85355C6.25979 5.94732 6.13261 6 6 6H2.5C2.36739 6 2.24021 5.94732 2.14645 5.85355C2.05268 5.75979 2 5.63261 2 5.5ZM2 8.5C2 8.36739 2.05268 8.24021 2.14645 8.14645C2.24021 8.05268 2.36739 8 2.5 8H6C6.13261 8 6.25979 8.05268 6.35355 8.14645C6.44732 8.24021 6.5 8.36739 6.5 8.5C6.5 8.63261 6.44732 8.75979 6.35355 8.85355C6.25979 8.94732 6.13261 9 6 9H2.5C2.36739 9 2.24021 8.94732 2.14645 8.85355C2.05268 8.75979 2 8.63261 2 8.5ZM2 10.5C2 10.3674 2.05268 10.2402 2.14645 10.1464C2.24021 10.0527 2.36739 10 2.5 10H6C6.13261 10 6.25979 10.0527 6.35355 10.1464C6.44732 10.2402 6.5 10.3674 6.5 10.5C6.5 10.6326 6.44732 10.7598 6.35355 10.8536C6.25979 10.9473 6.13261 11 6 11H2.5C2.36739 11 2.24021 10.9473 2.14645 10.8536C2.05268 10.7598 2 10.6326 2 10.5Z" />
                      ...
                      <!-- Menu: Sub menu ul -->
                      <ul class="sub-menu collapse" id="menu-Transfer">
                          <li><a class="ms-link" href="{{ url('transfer/create') }}">Add New Warehouse To
                                  Warehouse</a></li>
                          <li><a class="ms-link" href="{{ url('transfer') }}">List of Warehouse To Warehouse</a></li>
                          <li><a class="ms-link" href="{{ url('warehouse-branch-transfer/create') }}">Add New
                                  Warehouse To Branch</a></li>
                          <li><a class="ms-link" href="{{ url('warehouse-branch-transfer') }}">List of Warehouse To
                                  Branch</a></li>

                      </ul>
                  </li>
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Purchases" href="#">
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor"
                              viewBox="0 0 16 16">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M2 1C1.46957 1 0.960859 1.21071 0.585786 1.58579C0.210714 1.96086 0 2.46957 0 3L0 13C0 13.5304 0.210714 14.0391 0.585786 14.4142C0.960859 14.7893 1.46957 15 2 15H14C14.5304 15 15.0391 14.7893 15.4142 14.4142C15.7893 14.0391 16 13.5304 16 13V3C16 2.46957 15.7893 1.96086 15.4142 1.58579C15.0391 1.21071 14.5304 1 14 1H2ZM1 3C1 2.73478 1.10536 2.48043 1.29289 2.29289C1.48043 2.10536 1.73478 2 2 2H14C14.2652 2 14.5196 2.10536 14.7071 2.29289C14.8946 2.48043 15 2.73478 15 3V13C15 13.2652 14.8946 13.5196 14.7071 13.7071C14.5196 13.8946 14.2652 14 14 14H2C1.73478 14 1.48043 13.8946 1.29289 13.7071C1.10536 13.5196 1 13.2652 1 13V3ZM2 5.5C2 5.36739 2.05268 5.24021 2.14645 5.14645C2.24021 5.05268 2.36739 5 2.5 5H6C6.13261 5 6.25979 5.05268 6.35355 5.14645C6.44732 5.24021 6.5 5.36739 6.5 5.5C6.5 5.63261 6.44732 5.75979 6.35355 5.85355C6.25979 5.94732 6.13261 6 6 6H2.5C2.36739 6 2.24021 5.94732 2.14645 5.85355C2.05268 5.75979 2 5.63261 2 5.5ZM2 8.5C2 8.36739 2.05268 8.24021 2.14645 8.14645C2.24021 8.05268 2.36739 8 2.5 8H6C6.13261 8 6.25979 8.05268 6.35355 8.14645C6.44732 8.24021 6.5 8.36739 6.5 8.5C6.5 8.63261 6.44732 8.75979 6.35355 8.85355C6.25979 8.94732 6.13261 9 6 9H2.5C2.36739 9 2.24021 8.94732 2.14645 8.85355C2.05268 8.75979 2 8.63261 2 8.5ZM2 10.5C2 10.3674 2.05268 10.2402 2.14645 10.1464C2.24021 10.0527 2.36739 10 2.5 10H6C6.13261 10 6.25979 10.0527 6.35355 10.1464C6.44732 10.2402 6.5 10.3674 6.5 10.5C6.5 10.6326 6.44732 10.7598 6.35355 10.8536C6.25979 10.9473 6.13261 11 6 11H2.5C2.36739 11 2.24021 10.9473 2.14645 10.8536C2.05268 10.7598 2 10.6326 2 10.5Z" />
                      ...
                      <!-- Menu: Sub menu ul -->
                      <ul class="sub-menu collapse" id="menu-Purchases">
                          <li><a class="ms-link" href="{{ url('purchases/create') }}">Add New Purchases</a></li>
                          <li><a class="ms-link" href="{{ url('purchases') }}">List of Purchases</a></li>
                          <li><a class="ms-link" href="{{ url('purchase-return/create') }}">Purchases Return</a></li>
                          <li><a class="ms-link" href="{{ url('purchase-return') }}">Purchases Return list</a></li>
                      </ul>
                  </li>
                  <li class="collapsed">
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Client">
                          <li><a class="ms-link" href="{{ url('client/create') }}">Add New Customer</a></li>
                          <li><a class="ms-link" href="{{ url('client') }}">List of Customer</a></li>
                          {{-- <li><a class="ms-link" href="">Whole Sale Customer</a></li>
                          <li><a class="ms-link" href="">Online Sale Customer</a></li> --}}
                      </ul>
                  </li>
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Suppliers" href="#">
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor"
                              viewBox="0 0 16 16">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M2 1C1.46957 1 0.960859 1.21071 0.585786 1.58579C0.210714 1.96086 0 2.46957 0 3L0 13C0 13.5304 0.210714 14.0391 0.585786 14.4142C0.960859 14.7893 1.46957 15 2 15H14C14.5304 15 15.0391 14.7893 15.4142 14.4142C15.7893 14.0391 16 13.5304 16 13V3C16 2.46957 15.7893 1.96086 15.4142 1.58579C15.0391 1.21071 14.5304 1 14 1H2ZM1 3C1 2.73478 1.10536 2.48043 1.29289 2.29289C1.48043 2.10536 1.73478 2 2 2H14C14.2652 2 14.5196 2.10536 14.7071 2.29289C14.8946 2.48043 15 2.73478 15 3V13C15 13.2652 14.8946 13.5196 14.7071 13.7071C14.5196 13.8946 14.2652 14 14 14H2C1.73478 14 1.48043 13.8946 1.29289 13.7071C1.10536 13.5196 1 13.2652 1 13V3ZM2 5.5C2 5.36739 2.05268 5.24021 2.14645 5.14645C2.24021 5.05268 2.36739 5 2.5 5H6C6.13261 5 6.25979 5.05268 6.35355 5.14645C6.44732 5.24021 6.5 5.36739 6.5 5.5C6.5 5.63261 6.44732 5.75979 6.35355 5.85355C6.25979 5.94732 6.13261 6 6 6H2.5C2.36739 6 2.24021 5.94732 2.14645 5.85355C2.05268 5.75979 2 5.63261 2 5.5ZM2 8.5C2 8.36739 2.05268 8.24021 2.14645 8.14645C2.24021 8.05268 2.36739 8 2.5 8H6C6.13261 8 6.25979 8.05268 6.35355 8.14645C6.44732 8.24021 6.5 8.36739 6.5 8.5C6.5 8.63261 6.44732 8.75979 6.35355 8.85355C6.25979 8.94732 6.13261 9 6 9H2.5C2.36739 9 2.24021 8.94732 2.14645 8.85355C2.05268 8.75979 2 8.63261 2 8.5ZM2 10.5C2 10.3674 2.05268 10.2402 2.14645 10.1464C2.24021 10.0527 2.36739 10 2.5 10H6C6.13261 10 6.25979 10.0527 6.35355 10.1464C6.44732 10.2402 6.5 10.3674 6.5 10.5C6.5 10.6326 6.44732 10.7598 6.35355 10.8536C6.25979 10.9473 6.13261 11 6 11H2.5C2.36739 11 2.24021 10.9473 2.14645 10.8536C2.05268 10.7598 2 10.6326 2 10.5Z" />
                      ...
                      <!-- Menu: Sub menu ul -->
                      <ul class="sub-menu collapse" id="menu-Suppliers">
                          <li><a class="ms-link" href="{{ url('suppliers/create') }}">Add New Suppliers</a></li>
                          <li><a class="ms-link" href="{{ url('suppliers') }}">List of Suppliers</a></li>
                          <li><a class="ms-link" href="supplier-payment">Supplier Payment</a></li>
                          {{-- <li><a class="ms-link" href="">Payment Report</a></li> --}}
                      </ul>
                  </li>
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Report">
                          <li><a class="ms-link ms-2" href="{{ url('report/date-wise-transfers-report') }}">Date Wise
                          ...
                          <li><a class="ms-link" data-bs-toggle="collapse" data-bs-target="#menu-Sales"
                              ...
                              <ul class="sub-menu collapse" id="menu-Sales">
                                  <li><a class="ms-link" href="{{ url('') }}">Date Wise Transfers report</a>
                                  </li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="menu-Purchase">
                                  <li><a class="ms-link" href="{{ url('') }}">Date Wise Purchase </a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <!-- Menu: Sub menu ul -->
                              <ul class="sub-menu collapse" id="menu-client">
                                  <li><a class="ms-link" href="{{ url('') }}">Client Ledger</a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="menu-supplier">
                                  <li><a class="ms-link" href="{{ url('') }}">Supplier Ledger</a></li>
                          ...
                          <li class="collapsed">
                              ...
                              <ul class="sub-menu collapse" id="menu-Profitloss">
                                  <li><a class="ms-link" href="{{ url('') }}">Profit / loss</a></li>
                  ...
                  <li class="collapsed">
                      ...
                      <ul class="sub-menu collapse" id="menu-Settings">
                          ...
                          <li class="collapsed">
                              <a class="m-link" data-bs-toggle="collapse" data-bs-target="#restaurantTable"
                                  href="#">
                              ...
                              <!-- Menu: Sub menu ul -->
                              <ul class="sub-menu collapse" id="restaurantTable">
                                  <li><a class="ms-link" href="{{ url('restaurant-table/create') }}"> Add New
                                          Table</a>
                                  </li>
                                  <li><a class="ms-link" href="{{ url('restaurant-table') }}"> List of Table</a></li>
                          </li>
                  ...
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#ExpenseHeadings" href="#">
                  ...
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#Warehouses" href="">
                  ...
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#ProductColor" href="#">

                          <span class="ms-2">Product Color</span>
                          <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                      </a>
                      <!-- Menu: Sub menu ul -->
                      <ul class="sub-menu collapse" id="ProductColor">
                          <li><a class="ms-link" href="{{ url('product-color') }}"> List of Product Color</a>
                          </li>
                          <li><a class="ms-link" href="{{ url('product-color/create') }}"> Add New Product
                                  Color</a></li>

                      </ul>
                  </li>
                  <li class="collapsed">
                      <a class="m-link" data-bs-toggle="collapse" data-bs-target="#ProductSize" href="#">

                          <span class="ms-2">Product Size</span>
                          <span class="arrow fa fa-angle-right ms-auto text-end"></span>
                      </a>
                      <!-- Menu: Sub menu ul -->
                      <ul class="sub-menu collapse" id="ProductSize">
                          <li><a class="ms-link" href="{{ url('attributes') }}"> List of Product Size</a>
                          </li>
                          <li><a class="ms-link" href="{{ url('attributes/create') }}"> Add New Product
                                  Size</a></li>
