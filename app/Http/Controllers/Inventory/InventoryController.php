...
$total_sales_return = DB::table("pos_sale_products")->where('product_id','=',$row->product_id)->sum("quantity");
...
//              print_r($warehouse);
            $stock = $total_purchase - $total_purchase_return - ($total_sales - $total_sales);
