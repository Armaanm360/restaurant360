...
class BranchController extends Controller
{
    ...
    {
        $branchList = Branch::where('branch_status', 1)->where('v_branch', Auth::user()->version)->where('branch_created_by', Auth::user()->unique_user_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        $branch->branch_created_by =  Auth::user()->unique_user_id;
        $branch->v_branch =  Auth::user()->version;
