...
class ClientController extends Controller
{
    ...
    //     public function quick_create_client(Request $request)
    // {
    //     $request->validate([
    //         'client_name' => 'required',
    //     ]);
    ...
    //     $client = new Client();
    //     $client->client_name = $request->client_name;
    //     $client->branch_id = Auth::user()->branch;
    //     $client->client_entry_id = rand(46546,54156156);
    //     $client->client_phone_number = $request->client_phone_number;
    //     $client->client_created_by =  Auth::user()->id;
    //     $client->created_at = date("Y-m-d");
    //     $client->save();
        
    //     return \Illuminate\Support\Facades\Response::json($client);
    ...
    public function quick_create_client(Request $request)
    {
        ...
        $client->client_name = $request->client_name;
        $client->branch_id = Auth::user()->branch;
        $client->client_entry_id = rand(10000,500000);
        $client->client_phone_number = $request->client_phone_number;
        // $client->client_type = "";
        $client->client_created_by =  Auth::user()->id;
        $client->created_at = date("Y-m-d");
